...
<div class="Xapp-link">
  <div class="card-link" @click="vuePush('fra-multiply1-index')">
    <div class="Xapp-card -Xshadow">
      <img src="@/assets/images/fra/standard/Multiply1.png" class="book-large" />
    </div>
  </div>
</div>
...
<!-- begin mc2 sdcard bookImage -->
<div class="Xapp-link">
  <div class="card-link" @click="vuePush('fra-multiply2-index')">
    <div class="Xapp-card -Xshadow">
      <img src="@/assets/images/fra/standard/Multiply2.png" class="book-large" />
    </div>
  </div>
</div>
<!-- end mc2 sdcard bookImage -->
<!-- begin mc2 sdcard bookImage -->
<div class="Xapp-link">
  <div class="card-link" @click="vuePush('fra-multiply3-index')">
    <div class="Xapp-card -Xshadow">
      <img src="@/assets/images/fra/standard/Multiply3.png" class="book-large" />
    </div>
  </div>
</div>
<!-- end mc2 sdcard bookImage -->
<!-- begin mc2 sdcard bookImage -->
<div class="Xapp-link">
  <div class="card-link" @click="vuePush('fra-tc-index')">
    <div class="Xapp-card -Xshadow">
      <img src="@/assets/images/fra/standard/MessagesTransmissibles.png" class="book-large" />
    </div>
  </div>
</div>
<!-- end mc2 sdcard bookImage -->
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'library: ', '/content/M2/fra/index.html')">
