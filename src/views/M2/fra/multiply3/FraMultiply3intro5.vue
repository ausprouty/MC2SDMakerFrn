...
<div id="showVideoOptions"></div>
  <h1>   
    ...
    <vue-image-zoomer
    regular="/images/zoom/fra/multiply3/Trip3.png" 
    zoom="/images/zoom/fra/multiply3/Trip3.png" :zoom-amount="3" img-class="img-fluid" alt="Trip3">
    <img src="@/assets/images/fra/multiply3/Trip3.png" img-class="img-fluid" />
    </vue-image-zoomer>
    </div></h1>
